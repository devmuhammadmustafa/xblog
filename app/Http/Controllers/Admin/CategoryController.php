...
class CategoryController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->back()->with('type', "success")->with('message', "Category created successfully!!!");
    }
    ...
    public function delete($id) {
        ...
        if($category->childs->count() > 0) {
            return redirect()->back()->with('type', "info")->with('message', "Firstly delete child categories!!!");
        }
        $category->delete();
