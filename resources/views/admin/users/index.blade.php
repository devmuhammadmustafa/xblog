    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <a href="{{route("admin.user.create")}}" class="dt-button buttons-pdf buttons-html5 btn bg-teal-400" tabindex="0" aria-controls="DataTables_Table_1" type="button"><span>Create Users</span></a>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="list-icons">
                            <a href="{{route("admin.user.edit", $user->id)}}" class="dropdown-item"><i class="icon-database-edit2"></i></a>
                            <a href="{{route("admin.user.delete", $user->id)}}" class="dropdown-item"><i class="icon-trash"></i></a>
                        </div>
                    </td>
                </tr>
            @endforeach
